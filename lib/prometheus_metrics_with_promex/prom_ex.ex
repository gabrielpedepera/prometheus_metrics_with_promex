defmodule PrometheusMetricsWithPromex.PromEx do
  @moduledoc """
  ...
  2. Add this module to your application supervision tree. It should be one of the first
     ...
     def start(_type, _args) do
       children = [
         PrometheusMetricsWithPromex.PromEx,
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule PrometheusMetricsWithPromexWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :prometheus_metrics_with_promex
  ...
  use PromEx, otp_app: :prometheus_metrics_with_promex
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam
      # {Plugins.Phoenix, router: PrometheusMetricsWithPromexWeb.Router, endpoint: PrometheusMetricsWithPromexWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
      ...
      # PrometheusMetricsWithPromex.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:prometheus_metrics_with_promex, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
